...
| `fm-ensure-agents-md.sh` | Ensure a project's real `AGENTS.md`, its `CLAUDE.md` `@AGENTS.md` import file, and the canonical self-governance section |
...
| `fm-proc-lib.sh`         | Shared portable process primitives: harness-ancestry walk, holder liveness, ancestry membership, cmdline, pgid |
