...
FM_LOCK_STALE_AFTER=2   # seconds before dead-pid lock records can be reclaimed; locks younger than max(this, 5s) are never stealable, covering mid-acquire windows and momentary liveness-probe false negatives on slow-fork platforms
